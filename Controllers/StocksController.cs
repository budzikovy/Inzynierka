...
namespace Inz_Fn.Controllers
{
    ...
    public class StocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Stock_Id,User_Id,Price_per_stock,Amount")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Stock_Id,User_Id,Price_per_stock,Amount")] Stock stock)
        {
            if (id != stock.Id)
            {
                return NotFound();
